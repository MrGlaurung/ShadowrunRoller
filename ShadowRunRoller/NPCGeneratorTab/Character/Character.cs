...
namespace ShadowRunRoller.NPCGeneratorTab.Character
{
    public class Character
    {
        ...
        {
            if (object.ReferenceEquals(firstChar, null) || object.ReferenceEquals(secondChar, null))
            {
                return false;
            }
        ...
        {
            if (object.ReferenceEquals(obj, null) || obj.GetType() != typeof(Character)) return false;
